...
def getFractureBoxes( abstractFracGeomGetter ):
	...
	if fileType == "GEOSxml":
		...
		intCoordx, intCoordy, intCoordz = readGEOSxml( fileName )
	...
	# return fracBoxes
	return intCoordx, intCoordy, intCoordz
...
def readGEOSxml( abstractFracGeomReader ):
	coordList = getCoordListGEOSxml( fileName )
	#fracBoxes = makeFracBoxGEOSxml( coordList )
	intCoordx, intCoordy, intCoordz = makeFracBoxGEOSxml( coordList )
	# return fracBoxes
	return intCoordx, intCoordy, intCoordz
	
def abstractCoordListGetter():
	""" Set of converters between fracture-geometry-file specifics and fractureBox implementation.
	"""

def getCoordListGEOSxml( abstractCoordListGetter ):
...
def makeFracBoxGEOSxml( abstractFracBoxMaker ):
	# TODO: 
